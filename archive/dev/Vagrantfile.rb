...
# SSL Keys
SSL_KEY = "/usr/share/ca-certificates/charles.key"
SSL_CRT = "/usr/share/ca-certificates/charles.crt"
SSL_PEM = "/usr/share/ca-certificates/charles.pem"
...
Vagrant.configure("2") do |config|
  ...
  config.vm.provider :virtualbox do |vb|
    ...
    if "#{HTTPS_PROXY_ENABLE}" == "true"
      config.vm.provision "shell", inline: <<-HTTPS_CONFIG

# Experiimenting with local proxy - sInstall root certificate
...
BREX
cat /etc/network/interfaces.d/br-ex.cfg
